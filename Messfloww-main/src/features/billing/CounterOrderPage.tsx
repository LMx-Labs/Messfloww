    ...
    <div className="space-y-6 print:hidden">
      ...
      {step === "cart" ? (
          ...
          <div className="lg:col-span-2">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
              {currentSlotMenu.map((item) => {
                ...
                return (
                  <button key={item.id} onClick={() => addToCart(item)} className="bg-card hover:bg-primary hover:text-primary-foreground group text-foreground rounded-xl p-4 border border-border transition-all text-left shadow-sm hover:shadow-md h-full flex flex-col justify-between">
                    <div>
            ...
            <div className="bg-card rounded-xl p-6 border border-border sticky top-6">
              ...
              {cart.length === 0 ? (
                ...
                <>
                  ...
                  <button onClick={() => setStep("lookup")} disabled={cart.length === 0 || !hasSufficientStock} className="w-full bg-primary hover:bg-secondary text-primary-foreground px-6 py-4 rounded-xl font-semibold shadow-md disabled:opacity-50">Confirm Order</button>
                </>
              )}
            </div>
          </div>
        ...
        <div className="max-w-2xl mx-auto space-y-6">
          ...
          <button onClick={handlePlaceOrder} disabled={!canPlaceOrder || isPlacing} className="w-full mt-6 bg-primary hover:bg-secondary text-primary-foreground px-6 py-4 rounded-xl font-semibold shadow-md disabled:opacity-50">
